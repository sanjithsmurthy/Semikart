...
import '../cart/cart_page.dart'; // Import CartPage to access cartItemCount
...
class _BaseScaffoldState extends State<BaseScaffold> {
  ...
  final List<Widget> _pages = [
    ...
    const ProfileScreen(), // Replace with your ProfilePage widget
  ];
      ...
      icon: Stack(
        ...
        children: [
          ...
          ValueListenableBuilder<int>(
            valueListenable: cartItemCount, // Listen to cartItemCount globally
            builder: (_, count, __) {
              if (count > 0) {
                return Positioned(
                  right: -6,
